  ...
  <section v-if="activity" :class="['', loading ? ' animate-pulse blur-lg cursor-progress' : '']">
    <div class="mx-auto max-w-7xl overflow-hidden px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      ...
      <div class="flex gap-4 flex-col mb-3 lg:flex-row">
        ...
        <div class="w-full lg:w-8/12">
          ...
          <div data-test="participants" class="flex justify-start items-start gap-2 my-4">
            <svg
              v-if="activity.activity.participants === 1"
              data-test="one"
              width="24"
              height="16"
              viewBox="0 0 24 16"
          ...
          <p class="mt-2 font-normal text-lg text-gray-900">
            {{ activity.points }} {{ i18n.es.points }}
          </p>
        </div>
      </div>
      <div class="w-6/12">
        <div class="lg:mt-12">
          <p class="flex w-[7.5rem] text-lg font-medium border-b-4 border-b-red-500">
            {{ i18n.es['what-is-included'] }}
          </p>
      ...
      <div class="mt-10">
        ...
        <ActivityList
          v-if="relatedActivity"
          :activities="relatedActivity.slice(0, 4)"
          :grid-length="4"
          @click="onClickActivity"
          class="lg:-pl-8 lg:-ml-8"
        />
      </div>
    </div>
  </section>
